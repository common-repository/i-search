...
/* renamed to isrc_Mobile_Detect because plugins are loaded before themes and some themes use the same class without exists check and this is fatal */

class isrc_Mobile_Detect
{
    /**
